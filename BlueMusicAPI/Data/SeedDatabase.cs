    ...
    public static class SeedDatabase
    {
        ...
        {        
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                {
                    context.Music.Add(new Music { Name = "Aways", Author = "Bon Jovi", Duration = 180, Link = "" });
                    context.Music.Add(new Music { Name = "Hotel California", Author = "The Eagles", Duration = 360, Link = "" });
